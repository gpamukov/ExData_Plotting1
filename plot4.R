...
## * generates plot4 as per requirements and outputs to png
...
#plot1
with(data_dt, plot(Global_active_power ~ DateTime, type = "l", xlab = "", ylab = "Global Active Power"))

#plot2
with(data_dt, plot(Voltage ~ DateTime, type = "l", xlab = "datetime"))

#plot3
with (data_dt, plot(Sub_metering_1 ~ DateTime, type = "l", ylab = "Energy sub metering", xlab = ""))
with (data_dt, lines(Sub_metering_2 ~ DateTime, type = "l", col = "red"))
with (data_dt, lines(Sub_metering_3 ~ DateTime, type = "l", col = "blue"))
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, col = c("black", "red", "blue"), cex = 0.35, bty = "n")

#plot4
with(data_dt, plot(Global_reactive_power ~ DateTime, type = "l", xlab = "datetime"))
